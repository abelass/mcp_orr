<?php
/**
 * Fichier gérant l'installation et désinstallation du plugin Mcp Orr
 *
 * @plugin     Mcp Orr
 * @copyright  2013
 * @author     Rainer Müller
 * @licence    GNU/GPL
 * @package    SPIP\Mcp_orr\Installation
 */
...
/**
 * Fonction d'installation et de mise à jour du plugin Mcp Orr.
 *
 * Vous pouvez :
 *
 ...
 * @return void
**/
function mcp_orr_upgrade($nom_meta_base_version, $version_cible) {
	$maj = array();
	# quelques exemples
	...
	#	array('ecrire_config', array('mcp_orr', array('exemple' => "Texte de l'exemple")))
	#);
	#
...
/**
 * Fonction de désinstallation du plugin Mcp Orr.
 * 
 * Vous devez :
 *
 ...
 * @return void
**/
function mcp_orr_vider_tables($nom_meta_base_version) {
	# quelques exemples
	# (que vous pouvez supprimer !)
	# sql_drop_table("spip_xx");
	# sql_drop_table("spip_xx_liens");

	sql_drop_table("spip_orr_ressources_liens");
